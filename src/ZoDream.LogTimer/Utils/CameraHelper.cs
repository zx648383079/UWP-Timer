...
{
    /// <summary>
    /// Copy Source From https://github.com/CommunityToolkit/WindowsCommunityToolkit
    /// </summary>
    public class CameraHelper: IDisposable
    {
        ...
        private void Reader_FrameArrived(MediaFrameReader sender, MediaFrameArrivedEventArgs args)
        {
            ...
            if (frame != null)
            {
                ...
                EventHandler<CameraFrameEventArgs> handler = FrameArrived;
                var frameArgs = new CameraFrameEventArgs() { VideoFrame = vmf.GetVideoFrame() };
